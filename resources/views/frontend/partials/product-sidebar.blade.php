...
<a href="#main-{{$parent->id}}" class="list-group-item list-item-action" data-toggle="collapse">
...
" id="main-{{$parent->id}}" >
  ...
  <a href="{{route('categories.show', $child->id)}}" class="list-group-item list-item-action
